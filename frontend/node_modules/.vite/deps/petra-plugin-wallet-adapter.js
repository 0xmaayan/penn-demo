...
// node_modules/.pnpm/petra-plugin-wallet-adapter@0.4.4_@aptos-labs+ts-sdk@1.7.0_@aptos-labs+wallet-adapter-core@3.6.0_aptos@1.21.0/node_modules/petra-plugin-wallet-adapter/dist/index.mjs
  ...
  async signTransaction(transactionOrPayload, optionsOrAsFeePayer) {
    ...
    if ("rawTransaction" in transactionOrPayload) {
      ...
      try {
        ...
        return convertV1toV2(accountAuthenticator, n);
      } catch (err) {
        if (isObjectPropsUnsupportedError(err)) {
